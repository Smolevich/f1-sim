...
const RIGS: Record<CameraMode, Rig> = {
  // 17 м позади и 7 м вверх давали болид размером с муравья: ни модели, ни
  // клевков кузова на торможении разглядеть было нельзя. В гоночных играх
  // погоня стоит в 7-9 м и на 2-3 м выше машины.
  chase: { back: 8, height: 2.9, ahead: 6 },
  tcam: { back: 5.0, height: 1.9, ahead: 9 },
